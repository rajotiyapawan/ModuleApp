...
class GetPokemonSpeciesDataUseCase(private val repository: PokemonRepository) {
    operator fun invoke(params: RequestModel) = repository.getPokemonSpeciesData(params)
}