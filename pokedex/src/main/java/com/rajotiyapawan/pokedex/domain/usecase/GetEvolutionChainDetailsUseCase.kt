 ...
 */
class GetEvolutionChainDetailsUseCase(private val repository: PokemonRepository) {
    operator fun invoke(params: RequestModel) = repository.getEvolutionDetails(params)
}